...
\secref{sec:bpmnReasoning} looks at a few of the difficulties of automating the BPMN-to-Promela translation process.
\secref{sec:envConstruction} examines the construction of the environment, including variables and where and how to modify them.
...
\secref{sec:eval} provides the set of examples this tool is evaluated on, explaining the unique aspects of each example, as well as providing performance statistics.